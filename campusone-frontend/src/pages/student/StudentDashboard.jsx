...
const StudentDashboard = () => {
  ...
  const quickLinks = [
    { icon: UserCheck, label: 'Attendance', path: '/student/attendance', color: '#3b82f6' },
    { icon: ClipboardList, label: 'Assignments', path: '/student/assignments', color: '#10b981' },
    { icon: FileText, label: 'Quizzes', path: '/student/quizzes', color: '#f59e0b' },
    { icon: MessageSquare, label: 'Q&A Forum', path: '/student/qna', color: '#8b5cf6' },
    { icon: Bell, label: 'Notifications', path: '/student/notification', color: '#ef4444' },
  ];
  ...
  return (
    <div className="max-w-[1400px] mx-auto">
      <div className="mb-8">
        ...
        <p className="text-base text-slate-500 m-0">Here's your student portal.</p>
      </div>
